...
import (
	v1alpha1 "github.com/shaoxt/pipeline/pkg/apis/demo/v1alpha1"
	"github.com/shaoxt/pipeline/pkg/client/clientset/versioned/scheme"
...
// DemoV1alpha1Client is used to interact with features provided by the demo group.
type DemoV1alpha1Client struct {
	restClient rest.Interface
}

func (c *DemoV1alpha1Client) Applications(namespace string) ApplicationInterface {
	return newApplications(c, namespace)
}

func (c *DemoV1alpha1Client) Pipelines(namespace string) PipelineInterface {
	return newPipelines(c, namespace)
}

func (c *DemoV1alpha1Client) Stacks(namespace string) StackInterface {
