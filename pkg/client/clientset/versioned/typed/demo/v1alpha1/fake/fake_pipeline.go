...
var pipelinesResource = schema.GroupVersionResource{Group: "demo", Version: "v1alpha1", Resource: "pipelines"}

var pipelinesKind = schema.GroupVersionKind{Group: "demo", Version: "v1alpha1", Kind: "Pipeline"}
