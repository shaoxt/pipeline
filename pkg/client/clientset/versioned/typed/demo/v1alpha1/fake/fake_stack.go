...
var stacksResource = schema.GroupVersionResource{Group: "demo", Version: "v1alpha1", Resource: "stacks"}

var stacksKind = schema.GroupVersionKind{Group: "demo", Version: "v1alpha1", Kind: "Stack"}
