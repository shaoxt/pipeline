...
import (
	...
	demo_v1alpha1 "github.com/shaoxt/pipeline/pkg/apis/demo/v1alpha1"
	versioned "github.com/shaoxt/pipeline/pkg/client/clientset/versioned"
	internalinterfaces "github.com/shaoxt/pipeline/pkg/client/informers/externalversions/internalinterfaces"
	v1alpha1 "github.com/shaoxt/pipeline/pkg/client/listers/demo/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.DemoV1alpha1().Applications(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.DemoV1alpha1().Applications(namespace).Watch(options)
			},
		},
		&demo_v1alpha1.Application{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *applicationInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&demo_v1alpha1.Application{}, f.defaultInformer)
}
